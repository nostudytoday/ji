...
$(AddButton).click(function (e)  //on add input button click
{
        if(x <= MaxInputs) //max input box allowed
        {
			...
			} ?></select><font color="MediumSeaGreen"> 备注：</font><input name="remark[]" type="text" id="remark" style="width:120px;"/> 时间：<input type="date" name="time[]" id="time" value="<?php $xz=date("Y-m-d H:i"); echo "$xz"; ?>" style="width:120px;"/><a href="#" class="removeclass"> 删除</a><br /><br /></div>');
...
$(AddButton1).click(function (e)  //on add input button click
{
        if(y <= MaxInputs1) //max input box allowed
        {
			...
			while($acclass=mysql_fetch_array($query)){
				echo "<option value=$acclass[classid]>$acclass[classname]</option>";
			} ?></select><font color="red"> 备注：</font><input name="remark[]" type="text" id="remark" style="width:120px;"/> 时间：<input type="date" name="time[]" id="time" value="<?php $xz=date("Y-m-d H:i"); echo "$xz"; ?>" style="width:120px;"/><a href="#" class="removeclass"> 删除</a><br /><br /></div>');
