...
<form id="form2" name="myform2" method="post" onsubmit="return checkpost2();">
          　<font color="red">金额：</font><input name="money" type="number" step=".01" id="money" size="8" /><div style="display:none;"><input name="zhifu" type="text" id="zhifu" value="2" size="8" /></div>
...
<form id="form" name="myform" method="post" onsubmit="return checkpost();">
          　<font color="MediumSeaGreen">金额：</font>
            <input name="money" type="number" step=".01" id="money" value="" size="8" /><div style="display:none;"><input name="zhifu" type="text" id="zhifu" value="1" size="8" /></div>
